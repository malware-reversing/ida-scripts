...
Usage:
    ...
    This script will fail if current_address memory has not been populated (i.e. we did not start debugging and allow the malware to populate the data area with the function addresses.
